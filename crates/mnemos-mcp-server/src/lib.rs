...
///
/// Lets an agent observe whether learning is in shadow or active and how much
/// feedback has accumulated, without managing anything.
fn learning_summary() -> serde_json::Value {
    ...
    serde_json::json!({
        ...
        "note": "learning is automatic: just recall then reward; observe here",
    })
}
